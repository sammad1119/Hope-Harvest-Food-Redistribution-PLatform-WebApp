...
?>
  ...
  <head>
    <title>Hope Harvest|| Food Requests</title>
 ...
 where  tblfoodrequests.id='$fid'");
                  ...
                  <table border="1" class="table table-bordered mg-b-0">
                    <tr align="center">
                      <td colspan="4" style="font-size:20px;color:blue">
                        View Request Details of #<?php echo $row['requestNumber']; ?></td>
                    </tr>
                    <tr>
                      <th>Register By </th>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', function() {
          // Check if the window location includes "view-requestdetails.php"
          if (window.location.href.includes('view-requestdetails.php')) {
            // Add CSS style to the .footer class
